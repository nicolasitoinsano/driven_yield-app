...
/// Gestiona la ubicación geográfica en la Cl. 6 Sur #78q-2 a 78q-34 (Bogotá),
/// trazado de rutas en tiempo real (Google Maps, Waze, Apple Maps) y atención telefónica.
class LocationService {
  LocationService._();

  static final LocationService instance = LocationService._();

  // Coordenadas oficiales y datos del taller Driven Yield (Cl. 6 Sur #78q-2 a 78q-34, Bogotá, Colombia)
  static const double workshopLatitude = 4.6067;
  static const double workshopLongitude = -74.1558;
  static const String workshopName = 'Driven Yield — Taller Automotriz';
  static const String workshopAddress = 'Cl. 6 Sur #78q-2 a 78q-34, Bogotá, Colombia';
